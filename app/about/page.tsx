...
export const metadata: Metadata = {
  title: "About Us",
  description:
    "About PT VAV Technologies Indonesia — the parent company of Nobridge, an M&A advisory firm moving Indonesia forward through mergers, acquisitions, and strategic investment.",
...
const aboutJsonLd = {
  ...
  url: SITE_URL,
  description:
    "Parent company of Nobridge, moving Indonesia forward through mergers, acquisitions, and strategic investment.",
        ...
        <SectionPanel variant="dark" className="relative overflow-hidden">
          ...
          <div className="relative z-10 mt-6 mx-auto max-w-3xl text-center">
            ...
            <h1 className="mt-5 text-3xl font-medium leading-[1.1] tracking-[-2px] text-panel-white sm:text-4xl lg:text-5xl">
              A Parent Company Built to Grow Indonesia
            </h1>
            <p className="mt-5 text-base font-light leading-relaxed text-muted-gray">
              PT VAV Technologies Indonesia brings together capital, advisory, and ambition under one roof —
              as the parent company of Nobridge, our M&amp;A advisory firm — to move the country&apos;s
              businesses forward through mergers, acquisitions, and strategic investment.
            </p>
          </div>
        </SectionPanel>
      </ContentViewport>
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            <div className="border border-outline-light p-8">
              ...
              <p className="mt-3 text-sm font-light leading-relaxed text-body-gray">
                To move Indonesia forward by building and backing businesses that strengthen its economy —
                combining mergers, acquisitions, finance, and investment to help companies and the country
                grow.
              </p>
            </div>
            <div className="border border-outline-light p-8">
              ...
              <p className="mt-3 text-sm font-light leading-relaxed text-body-gray">
                A more capable Indonesian market, where founders and corporates have world-class advisory
                and patient capital to realize their ambitions.
              </p>
            </div>
          </div>
        </SectionPanel>
        ...
        <SectionPanel variant="muted">
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              { icon: Layers, title: "Integrated", desc: "Advisory, finance, and investment aligned under one parent company and one vision." },
      ...
      <ContentViewport>
        <SectionPanel variant="white">
          <div className="mx-auto max-w-3xl">
            ...
            <h2 className="mt-5 text-3xl font-normal tracking-tight">Backing Nobridge, Building Indonesia</h2>
            ...
            <div className="mt-8 flex flex-col gap-6 text-sm font-light leading-relaxed text-body-gray">
              <p>
                PT VAV Technologies Indonesia was founded on a simple belief: that the right combination of
                advisory expertise and capital can accelerate Indonesia&apos;s growth.
              </p>
              <p>
                Today the group is the parent company of <strong className="font-semibold text-primary-black">Nobridge</strong>,
                our mergers &amp; acquisitions advisory firm. Nobridge guides founders and corporates through
                buy-side and sell-side transactions — from origination and valuation through negotiation and
                close.
              </p>
              <p>
                Through Nobridge and our wider work in corporate finance and investment, we help the
                country&apos;s businesses scale and move Indonesia forward.
              </p>
              <p>
                We continue to grow our company, deepen our expertise, and invest in the opportunities that
                strengthen the economy.
              </p>
            </div>
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <GhostButton href="/company">Meet Nobridge</GhostButton>
            </div>
          </div>
        </SectionPanel>
      </ContentViewport>
